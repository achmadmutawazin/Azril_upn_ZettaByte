...
<html>
  ...
  <body>
    ...
    <script>
      function purchaseBook(title, author, price, discountPercent, taxPercent, stock, purchaseAmount) {
      ...
      purchaseBook("The Great Gatsby", "F. Scott Fitzgerald", 15.99, 20, 8.25, 10, 5);
    </script>
  </body>
</html>
